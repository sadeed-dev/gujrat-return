...
import { useGetAllLFAs } from "../../../hook/use-Lfa.hook"
import { useGetAllUsers } from "../../../hook/use-user.hook"
import { useAuth } from "../../../context/auth/AuthContext"
import { useLocation } from "react-router-dom"
import axios from "axios"
import LfaHeader from "./components/LfaHeader"
import ChatRoomsPage from "./offfer-lfa/ChatRoomsPage"
import { useGetAllRooms } from "../../../hook/use-lfachat.hook"
import LfaTable from "./components/LfaTable"
...
const LFAs = () => {
  ...
  const nonDeletedChatRooms = chatRooms?.filter(r => !r?.isDeleted)

  return (
    <Container maxWidth={false} disableGutters sx={{ backgroundColor: "#f9fafb", minHeight: "100vh" }}>
      <LfaHeader activeView={activeView} setActiveView={setActiveView} chatCount={nonDeletedChatRooms.length} />
